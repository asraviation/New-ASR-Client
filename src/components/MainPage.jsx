...
const MainPage = () => {
  // Removed the hero section related state and refs
  ...
  useEffect(() => {
    ...
    const ctx1 = gsap.context(() => {
      // Removed hero section animation

      tl4.from([h1Ref.current], {
        opacity: 0,
        x: -1000,
        duration: 0.5,
        ease: "sine.out",
      ...
      tl4.from([servicesh1Ref.current], {
        opacity: 0,
        y: -100,
        duration: 0.5,
        ease: "sine.out",
      ...
      tl4.from([servicesimgRef.current], {
        opacity: 0,
        x: -100,
        duration: 0.5,
        ease: "sine.out",
      ...
      tl4.from([servicesdescRef.current], {
        opacity: 0,
        y: -100,
        duration: 0.5,
        ease: "sine.out",
      ...
      tl4.from([servicesTitleRef.current], {
        opacity: 0,
        y: -100,
        duration: 0.5,
        ease: "sine.out",
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-white py-8 px-8 shadow-lg w-full ">
        ...
        >
          ...
          comfort to seamless service, every moment is designed for an
          exclusive, first-class experience that redefines private aviation.{" "}
        </p>
      </div>
